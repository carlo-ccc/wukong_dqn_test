...
#self_blood_window = BloodWindow(*convert_coordinates(138, 655, 294, 664))
...
gunshiline_window = GunShiWindow(*convert_coordinates(1133, 663, 1137, 671))
...
boss_blood_window = BloodWindow(*convert_coordinates(446, 609, 842, 616))
